    ...
    return (
      <div className={cn("space-y-2", containerClassName)}>
        ...
        <div className="relative group">
          ...
          <div
            className={cn(
              "absolute inset-0 bg-gradient-to-r from-orange-500 to-blue-500 rounded-xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-300",
            ...
            <input
              ...
              className={cn(
                ...
                error
                  ...
                  : "border-gray-200 dark:border-gray-700 focus:border-orange-500 dark:focus:border-orange-400 focus:ring-4 focus:ring-orange-500/10",
                inputClassName,
              )}
              {...props}
            />
