...
export default function VouchersList() {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      f = f.filter((v) => v.code.toLowerCase().includes(s));
    }
    setFiltered(f);
    setPage(0);
  }, [searchTerm, vouchers]);
  ...
  const handleDelete = async () => {
    ...
    try {
      await removeVoucher(voucherToDelete.id);
    ...
    >
      ...
      >
        <div>
          ...
          >
            Manage discount and entry voucher codes
          </p>
        </div>
                ...
                <TableRow>
                  <TableCell colSpan={8} align="center" sx={{ py: 10 }}>
                    ...
                    <p style={{ color: colors.textMuted, fontSize: "0.85rem" }}>
                      Try adjusting your search or add a new voucher
                    </p>
                  </TableCell>
                </TableRow>
              ) : (
