      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/forget-password"
              className="text-sm text-#2A4863-600 dark:text-#2A4863-400 hover:text-#2A4863-700 dark:hover:text-#2A4863-300 font-medium transition-colors"
            >
              Forget Password?
            </Link>
          </div>
        ...
        {/* <div className="flex items-center">
          <input
            id="remember"
            type="checkbox"
            className="w-4 h-4 rounded border-gray-300 text-#2A4863-600 focus:ring-#2A4863-500 focus:ring-2"
          />
          <label
            htmlFor="remember"
